const dataProduct = [
  ...
  },
  {
    ...
    sound: "",
    description: {
      product: "If talking about the brand Fender, many people who are experienced in the guitar industry will probably hear this name often. This model of Fender acoustic guitar is very popular, whether beginners or seasoned pros. The material used to make the body is considered high quality wood. causing the price to be a little too strong But the sound received is worth the price paid. Especially the use of mahogany contributes to making the sound soft. Soft and has dimensions as well. The two-way swivel neck brace allows for more freedom in adjusting the touching.",
      brand: "Fender",
      series: "Fender CD60s",
      color: "Black,White",
      note: "",
  ...
  },
  {
    ...
    sound: "",
    description: {
      product: "Yamaha TRBX174 bass, basic model, affordable price and get complete usage The body is mahogany that produces a good bass tone. Maple neck, clear midrange Rosewood Fingerboard This model comes with 2 Split Single Coil / Ceramic pickups, comes with a separate volume button for each pickup and a tone control knob, whether it's strum or slap. famous brand The design will be modern. Anyone looking for a good starter bass with a neat sound Come try this model and you will like it.",
      brand: "Yamaha",
  ...
  },
  {
    ...
    sound: "",
    description: {
      product: "The Sire Marcus Miller M2DX electric bass is the signature bass of Marcus Miller, renowned jazz bassist, composer and producer. Comes in the most intense form with bright tones. This model is a DX model which uses a maple top, unlike the M2, which has a mahogany body only. Makes it, in addition to getting beautiful and eye-catching wood grain The sound also has a more pleasing dimension.",
      brand: "Sire Marcus",
  ...
  },
  {
    ...
    sound: "",
    description: {
      product: "The Ibanez TMB35 is a good 5-string bass in the Talman series. This model will have a scale length of only 30 inches, easy to play, suitable for small people or those who do not like long bass. The sound is comfortable. No worries. Clear mids from a poplar body, maple neck, and Jabo fingerboard. Two pickups are available, the Dynamix P/J, giving the Talman Bass an impressive range of tones. From strong rock tones to intense R&B. It's got it all. Classic looks and modern flair. It is another model that is so good that it has to be recommended.",
      brand: "Ibanez",
      series: "Ibanez TMB35 ",
      color: "Black,White",
      note: "",
  ...
  },
  {
    ...
    sound: "",
    description: {
      product: "The Coleman F107 electric piano is ideal for those looking for an affordable electric piano. But get all the basic functions Because this model will have a maximum of 88 keys to support a wider range of music notes. Responds to almost every genre of music with 8 built-in tones With 128 more rhythms, it can be used for both personal practice or can be played live and recorded as you like. because it can be connected to a computer",
      brand: "Coleman  ",
      series: "Coleman F107",
      color: "Black,White",
      note: "",
  ...
  },
  {
    ...
    sound: "",
    description: {
      product: "NUX WK-310 Entry-level electric piano It gives you the ultimate piano playing feel with 5 levels of grand piano sounds recorded with 5-Level Dynamic Stereo Piano Sampling and Hammer-Action keys. With 4 dynamic curves, the weight is similar to that of a true grand piano.",
      brand: "NUX",
      series: "NUX WK-310",
      color: "Black,White",
      note: "",
  ...
  },
  {
    ...
    sound: "",
    description: {
      product: "This brand of violin is suitable for people who want to practice playing classical music. Because when playing the violin, it produces a sweet, clear, melodious sound, and can play both high and low sounds as well. In addition, the violin is made from real grade A wood. It's an excellent material. It is also available in four different sizes, giving players the opportunity to choose the right size violin for themselves. make the play effective and play more comfortably And most importantly, this shop has many accessories, including a moisture meter as well.",
      brand: "Elman",
      series: "Elman EL100",
      color: "Black,White",
      note: "",
  ...
  },
  {
    ...
    sound: "",
    description: {
      product: "A popular brand of violin that is internationally recognized for its excellent quality. This model is therefore suitable for beginners who want a well-known brand of violin",
      brand: "YAMAHA",
      series: "YAMAHA V3SKA",
      color: "Black,White",
      note: "",
  ...
  },
  {
    ...
    sound: "",
    description: {
      product: "cheap violins from china Make a beautiful sound that is pleasant to listen to. Made from all quality woods such as synthetic maple and spruce, plus blackwood fingerboard. The violin body is varnished. make it beautiful and look good And because this violin is relatively affordable and of good quality.",
      brand: "Elman",
      series: "Elman EL1500",
      color: "Black,White",
      note: "",
  ...
  },
  {
    ...
    sound: "",
    description: {
      product: "A drum set made by Thai people. It is a good quality drum set with 5 standard size drums. It is made of high quality wood. The hardware is durable. The edge of the drum is chrome plated to add beauty and coolness. durability A very suitable drum for beginners to play drums.",
      brand: "Overdrive",
      series: "Overdrive",
      color: "Black,White",
      note: "",
  ...
  },
  {
    ...
    sound: "",
    description: {
      product: "Presenting Mapex Prodigy, a complete 5-piece drum set that comes with Hardware, Cymble. The drum body is made of Basswood 9ply that gives your sound a thick, resonant tone. More than that, this drum set also comes Comes with Remo drum skins as well, suitable for drum set beginners.",
      brand: "Mapex Prodigy",
  ...
  },
  {
    ...
    sound: "",
    description: {
      product: "Cmc Indy Series that comes with quality and colors that are very beautiful. Using materials like poplar wood to make a shell drum that resonates clearly, but when listened to, there is a warm heart. Suitable for quite a variety of music styles, along with a snare made of steel that gives a sound that hits the heart. The drum unit is the same as the CMC Prelude, using a single drum unit bolt to enhance the sound performance.",
  ...
  },
  {
    ...
    sound: "",
    description: {
      product: "This drum set is a small size drum set from Yamaha that has a sound quality that is not small according to the size of the drum. The drum body is made of Brich wood that has special properties for a fast response sound, aggressive, clear sound. In addition to using Brich wood stacked up to 6 layers inside, you will receive a resonant sound that can withstand the impact and vibration of your strike as well. more special than that",
      brand: "Yamaha Stage Custom Hip ",
      series: "Yamaha Stage Custom Hip ",
      color: "Black,White",
      note: "",
    },
  },
  {
    ...
    sound: "",
    description: {
      product: "Ludwig, known by drummers around the world Today we are going to talk about the Ludwig Element Drive, a drum that comes with complete hardware, cymble. The drum body is made of 9ply poplarwood, giving a powerful resonant tone. Ludwig's standard quality durable hardware comes with a bronze cymble. The B8 bronze alloy offers a distinctive tone and is more durable than other beginner cymbals. This drum is ideal for beginner drummers. Step-up drummer or drummers who want a good sounding set.",
      brand: "Ludwig Element Drive ",
      series: "Ludwig Element Drive  ",
      color: "Black,White",
      note: "",
    },
  },
