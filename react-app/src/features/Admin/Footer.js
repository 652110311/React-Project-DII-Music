      ...
      <div class="container-fluid bg-secondary text-dark mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
          <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p class="mb-2">
              <i class="fa fa-map-marker-alt text-primary mr-3"></i> 239
              Huaykaew Rd.
            </p>
            <p class="mb-2">
              <i class="fa fa-envelope text-primary mr-3"></i>camt@cmu.ac.th
            </p>
            <p class="mb-0">
              <i class="fa fa-phone-alt text-primary mr-3"></i>053-941803
            </p>
          </div>
              ...
              <div class="col-md-4 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                  ...
                  <a class="text-dark mb-2" href="detail.html">
                    <i class="fa fa-angle-right mr-2"></i>Product Detail
                  </a>
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
          <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-dark">
              ...
              . All Rights Reserved. Designed by DII STUDENTS
            </p>
          </div>
