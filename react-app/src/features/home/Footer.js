    ...
    <div className="row px-xl-5 pt-5">
        <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href="" className="text-decoration-none">
                <h1 className="mb-4 display-5 font-weight-semi-bold"><span className="text-primary font-weight-bold border border-white px-3 mr-1">D</span>DII MUSIC</h1>
            </a>
            <p>Dolore erat dolor sit lorem vero amet. Sed sit lorem magna, ipsum no sit erat lorem et magna ipsum dolore amet erat.</p>
            <p className="mb-2"><i className="fa fa-map-marker-alt text-primary mr-3"></i> 239 Huaykaew Rd.</p>
            <p className="mb-2"><i className="fa fa-envelope text-primary mr-3"></i>camt@cmu.ac.th</p>
            <p className="mb-0"><i className="fa fa-phone-alt text-primary mr-3"></i>053-941803</p>
        </div>
            ...
            <div className="row">
                <div className="col-md-4 mb-5">
                    ...
                    <div className="d-flex flex-column justify-content-start">
                        ...
                        <a className="text-dark mb-2" href="detail.html"><i className="fa fa-angle-right mr-2"></i>Product Detail</a>
    ...
    <div className="row border-top border-light mx-xl-5 py-4">
        <div className="col-md-6 px-xl-0">
            <p className="mb-md-0 text-center text-md-left text-dark">
                &copy; <a className="text-dark font-weight-semi-bold" href="#">DII MUSIC</a>. All Rights Reserved. Designed
                by DII STUDENTS
